...
$yamlFile = "Additional_AI_Levels/config.yml"
...
$filesToCopy = @(
    "Additional_AI_Levels-AddedFiles/aail_config.json"
)

$destinationPaths = @(
    "../Data/configs/aail_config.json"
)
...
Set-Location ..
Write-Host "Building..."
cmd.exe /c "call ./psdk --util=plugin build Additional_AI_Levels"
